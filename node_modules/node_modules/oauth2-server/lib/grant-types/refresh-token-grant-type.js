  ...
  return promisify(this.model.getRefreshToken, 1).call(this.model, request.body.refresh_token)
    .then(function (token) {
      ...
      if (token.client.id !== client.id) {
        throw new InvalidGrantError('Invalid grant: refresh token is invalid2');
      }
      if (token.refreshTokenExpiresAt && !(new Date(token.refreshTokenExpiresAt) instanceof Date)) {
